...
OVERFLOW_FLAG_MASK = Mask(0b100, 2)

HALF_COPY_FLAG_MASK = Mask(0b10000, 4)
SIGNIFICANT_SRC_FLAG_MASK = Mask(0b01000, 3)
SIGNIFICANT_DST_FLAG_MASK = Mask(0b00100, 2)
OVERWRITE_FLAG_MASK = Mask(0b00010, 1)
IMMEDIATE_FLAG_MASK = Mask(0b00001, 0)

JUMP_CONDITION_FLAG = Mask(0b10000, 4)
JUMP_SUBTRACT_FLAG = Mask(0b01000, 3)
